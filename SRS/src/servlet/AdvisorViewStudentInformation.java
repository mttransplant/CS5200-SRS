...
/**
 * Servlet implementation class AdvisorViewStudentInformation
 */
@WebServlet("/AdvisorViewStudentInformation")
public class AdvisorViewStudentInformation extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdvisorViewStudentInformation() {
        super();
